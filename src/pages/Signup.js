    ...
    <div className="signup-container fade-in">
      ...
      >
        <svg className="google-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
          <path
            fill="#fbc02d"
            d="M43.6 20.5H42V20H24v8h11.3c-1.7 4.8-6.2 8-11.3 8-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.8 2.9l6-6C34.5 6.2 29.6 4 24 4C12.9 4 4 12.9 4 24s8.9 20 20 20c11 0 20-8 20-20 0-1.3-.1-2.7-.4-3.5z"
          />
          <path
            fill="#e53935"
          ...
          <path
            fill="#4caf50"
            d="M24 44c5.4 0 10.3-2.1 13.9-5.5l-6.4-5.4C29.7 34.6 27 36 24 36c-5.1 0-9.6-3.2-11.3-8l-6.5 5C9.3 39.4 16 44 24 44z"
          />
          <path
            fill="#1565c0"
            d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.4 4.3-4.3 5.6l6.4 5.4c.4-.3 6.6-5 6.6-15.5 0-1.3-.1-2.7-.4-3.5z"
          />
        </svg>
